<div class="container">
    <table class="table table-hover">
        ...
        <div class="row mt-4">
            <div class="col-md-2">
                <a href="<?= base_url(); ?>penjualanuser/tambah" class="btn btn-primary">Tambah Data Penjualan</a>
            </div>
            <div class="col-md-4">
                ...
                <tbody>
                    <?php foreach ($penjualan as $pe) : ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= base_url(); ?>penjualanuser/hapus/<?= $pe['kdpenjualan']; ?>" class="btn btn-danger btn-sm float-right" onclick="return confirm('Yakin Data ini akan dihapus');">Hapus</a>
                                <a href="<?= base_url(); ?>penjualanuser/edit/<?= $pe['kdpenjualan']; ?>" class="btn btn-success btn-sm float-right">Edit Penjualan</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
