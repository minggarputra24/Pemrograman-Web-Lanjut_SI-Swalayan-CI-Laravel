  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../../index3.html" class="brand-link">
      <img src="/adminlte/img/AdminLTELogo.png"
           ...
           style="opacity: .8">
      <span class="brand-text font-weight-light">Swalayanku</span>
    </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="/swalayan/dashboard" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/swalayan/kasir" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Data Kasir</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/swalayan/barang" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Data Barang</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/swalayan/penjualan" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Data Penjualan</p>
                </a>
              </li>
